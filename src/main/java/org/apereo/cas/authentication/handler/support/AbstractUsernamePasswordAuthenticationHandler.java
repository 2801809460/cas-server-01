...
public abstract class AbstractUsernamePasswordAuthenticationHandler extends AbstractPreAndPostProcessingAuthenticationHandler {
    ...
    protected HandlerResult doAuthentication(Credential credential) throws GeneralSecurityException, PreventedException {
        ...
        Object capcha = requestAttributes.getRequest().getSession()
                .getAttribute("capcha");
        System.out.println(capcha);
        System.out.println(((UsernamePasswordCredential) credential).getCapcha());
        if(!capcha.equals(((UsernamePasswordCredential) credential).getCapcha())){
